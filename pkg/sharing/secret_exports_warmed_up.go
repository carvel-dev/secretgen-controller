...
// Export delegates.
func (se *SecretExportsWarmedUp) Export(export *sgv1alpha1.SecretExport, secret *corev1.Secret) {
	se.delegate.Export(export, secret)
}

// Unexport delegates.
func (se *SecretExportsWarmedUp) Unexport(export *sgv1alpha1.SecretExport) {
