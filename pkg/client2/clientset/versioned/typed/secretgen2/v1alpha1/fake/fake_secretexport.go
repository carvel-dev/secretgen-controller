...
var secretexportsResource = schema.GroupVersionResource{Group: "secretgen.carvel.dev", Version: "v1alpha1", Resource: "secretexports"}

var secretexportsKind = schema.GroupVersionKind{Group: "secretgen.carvel.dev", Version: "v1alpha1", Kind: "SecretExport"}
...
func (c *FakeSecretExports) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSecretExports) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(secretexportsResource, c.ns, listOpts)
