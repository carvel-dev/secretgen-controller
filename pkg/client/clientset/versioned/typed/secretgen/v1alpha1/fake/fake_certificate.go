...
var certificatesResource = schema.GroupVersionResource{Group: "secretgen", Version: "v1alpha1", Resource: "certificates"}

var certificatesKind = schema.GroupVersionKind{Group: "secretgen", Version: "v1alpha1", Kind: "Certificate"}
