...
var sshkeysResource = schema.GroupVersionResource{Group: "secretgen", Version: "v1alpha1", Resource: "sshkeys"}

var sshkeysKind = schema.GroupVersionKind{Group: "secretgen", Version: "v1alpha1", Kind: "SSHKey"}
